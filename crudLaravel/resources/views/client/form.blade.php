 ...
 <h1>Crear cliente</h1>
   ...
   @endif
     ...
     <div class="mb-3">
      ...
      <input type="number" name="due" class="form-control" placeholder="Sueldo del cliente" value="{{old('due') ?? @$client->due}}" value="{{old('due') ?? @$client->due}}" step="0.01">
      <p class="form-text"> Escriba el sueldo del cliente </p>
